...
export const create_conversation = async (userId1, userId2) => {
    try {
...
export const create_message = async (senderId, conversationId, body) => {
    try {
...
const buildConversationWithUsers = async (conversationId) => {
    const result = await db.query(`
